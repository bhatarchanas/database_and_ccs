...
ccs1_file = Bio::FlatFile.auto("/data/shared/homes/archana/projects/BEI_mcsmrt_v1/pre_ee_pretrim.fq")
ccs2_file = Bio::FlatFile.auto("/data/shared/homes/archana/projects/BEI_ccs2/pre_ee_pretrim.fq")
outfile = File.open("ee_comparison.txt", "w")
